...
public class CustomerOracleDAOImpl implements ICustomerDAO {
	private static final String CUST_INSERT_QUERY = "INSERT INTO REALTIMEDI_SPRING_CUSTOMER VALUES(CUSTID_SEQ.NEXTVAL,?,?,?,?,?,?)";
	...
	public int insertCustomer(CustomerBO bo) throws Exception {
		System.out.println("CustomerOracleDAOImpl.insertCustomer()");
		int result = 0;
